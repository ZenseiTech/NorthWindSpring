...
public class Search {
    ...
    public static Specification<Object> getIntegerSpecification(List<Integer> expressions, String field,
    ...
    public static Specification<Object> getBigDecimalSpecification(List<BigDecimal> expressions, String field,
            SearchType searchType) {
    ...
    public static Specification<Object> getDateStringSpecification(List<String> expressions, String field,
            SearchType searchType) {
    ...
    public static Specification<Object> getDateSpecification(List<Date> expressions, String field,
            SearchType searchType) {
